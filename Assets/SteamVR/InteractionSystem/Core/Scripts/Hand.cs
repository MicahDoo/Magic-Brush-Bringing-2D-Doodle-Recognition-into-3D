...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public SteamVR_Behaviour_Pose trackedObject; // TODO: What is this? In this case the tracked object is the hand itself
        ...
        //                   i.e. which part of the hand should the object attach to
        //-------------------------------------------------
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            // TODO: when? Can both hands be attached?
        ...
        // TODO: Make the hand rig(?) follow this transform
            ...
            if (attachedObject != null)
            {
                if (currentAttachedObjectInfo.Value.interactable != null)
                {
                    ...
                    if (currentAttachedObjectInfo.Value.interactable.handFollowTransform)
                    {
                        ...
                        {
                            // TODO:
                            // This doesn't change the pos & rot of attachedObject at all, only the hand
        ...
        // TODO: After attached, the job of moving the grabbed object falls on FixedUpdate
        protected virtual void FixedUpdate()
        {
            if (currentAttachedObject != null) // One hand has only one attached object
            {
                // Move whatever is still attached
                // https://stackoverflow.com/questions/47422370/what-is-the-point-of-value-on-nullable-types-in-c-sharp
        ...
        // explicityType - if mouse input is received, what type of grab should it be
